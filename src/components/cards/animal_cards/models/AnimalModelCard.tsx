      ...
      {model.diff !== model.diffWithSpecialEnclosure && (
        <div className='text-bold'>
          ...
          <span
            className={cn(
              'text-bold',
              { 'text-amber-600': model.diffWithSpecialEnclosure >= 0 },
