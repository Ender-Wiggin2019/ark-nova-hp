 ...
 * @LastEditTime: 2024-08-10 23:46:25
 * @Description:
 */
...
export function StrengthFilter({
  ...
  return (
    <div className='hp-button group mt-1 flex w-48 flex-row items-center justify-center space-x-2 rounded-full px-4 py-2 text-sm font-medium text-blue-500 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur-md focus:outline-none focus-visible:ring-2 dark:from-zinc-900/30 dark:to-zinc-800/80 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20 dark:focus-visible:ring-yellow-500/80'>
